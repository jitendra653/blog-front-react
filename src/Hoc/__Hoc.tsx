...
export default function HOC() {
  return (
    <main>
      <header className="flex items-center fixed top-0 justify-between bg-violet-600 h-28 w-full">
      ...
      <section className="flex items-center bg-violet-600 h-[100vh] w-full mb-5">
        ...
        <img src="/header.png" alt=""  height={700} width={700} className="h-[100%] w-[100%]"/>
        </div>
      </section>
      ...
      <section className="flex items-center justify-evenly flex-wrap">
        <div className="bg-indigo-50 w-[25%] h-[50%] p-10 m-2 shadow-xl cursor-pointer">
          <img src="/code.jpg" alt="none" width={200} height={200} />
