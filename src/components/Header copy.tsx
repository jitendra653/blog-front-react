  ...
  return (
    <header className="bg-purple-800 text-white p-4 relative">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav
          className={`fixed md:flex md:items-center md:space-x-6 top-0 right-0 w-full md:w-auto bg-purple-800 md:bg-transparent shadow-md md:shadow-none transition-transform transform ${
